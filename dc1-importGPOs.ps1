...
#ADCS
Import-GPO -TargetName "HUN_ADCS"  -BackupGpoName "HUN_ADCS" -Path $utvonal
...
#ADCS
New-GPLink -Name "HUN_ADCS" -Domain $domain -Target "ou=DomainServers,DC=int,DC=beg,DC=01,dc=berylia,dc=org" -LinkEnabled yes
